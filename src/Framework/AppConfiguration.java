...
public class AppConfiguration {
    ...
    public static String getDBName() {
        if (config != null)
            ...
            System.out.println(
                    ">> (issue) AppConfiguration.getDB_NAME(), llamar primero a AppConfiguration.load() y agregar DB_NAME en CONFIG ");
        return "";
    }
    ...
    public static String getDBPathConnection() {
        ...
        if (config != null && config.containsKey(APP.GLOBAL.DB_PATH)) {
            ...
            System.out.println(
                    ">> (issue) AppConfiguration.DB_PATH(), llamar primero a AppConfiguration.load() y agregar DB_PATH en CONFIG ");
        return "";
    }
